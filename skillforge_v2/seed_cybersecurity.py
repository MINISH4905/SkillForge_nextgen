...
def run_seeding(num_levels=100):
    ...
    concepts = [
        "SQL Injection Prevention", "Cross-Site Scripting (XSS)", 
        "CSRF Protection", "Encryption & Hashing (Bcrypt/AES)", 
        "JWT Token Security", "OWASP Top 10", "Network Port Scanning Protection", 
        "Safe Data Sanitization", "Brute Force Mitigation", "OAuth 2.0 Flow Security",
        "Secure Headers (HSTS, CSP)", "Social Engineering Resilience"
    ]
